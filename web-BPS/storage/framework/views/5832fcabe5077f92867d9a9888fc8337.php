...
<head>
    ...
    <title><?php echo e($detail['title'] ?? 'Detail Publikasi'); ?> - Portal BPS</title>
    ...
    <main class="max-w-5xl mx-auto px-4 py-10 flex-1 w-full">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-6 md:p-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="flex flex-col items-center">
                        <img src="<?php echo e(!empty($detail['cover']) ? $detail['cover'] : 'https://placehold.co/300x400?text=Cover+Tidak+Tersedia'); ?>"
                             alt="<?php echo e($detail['title'] ?? 'Cover Publikasi'); ?>"
                        ...
                        <?php if(!empty($detail['pdf'])): ?>
                            <a href="<?php echo e($detail['pdf']); ?>" target="_blank" rel="noopener noreferrer"
                    ...
                    <div class="md:col-span-2 space-y-6">
                        <div>
                            ...
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
                                <?php echo e($detail['title'] ?? 'Judul Tidak Tersedia'); ?>
                        ...
                        <div>
                            ...
                            <div class="text-gray-700 leading-relaxed text-sm bg-gray-50 p-5 rounded-xl border border-gray-100">
                                <?php if(!empty($detail['abstract'])): ?>
                                    <?php echo nl2br(html_entity_decode($detail['abstract'])); ?>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16 bg-white rounded-2xl border border-gray-200 p-8 shadow-sm max-w-xl mx-auto">
                ...
                <a href="<?php echo e(route('home')); ?>" class="inline-block mt-6 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium text-sm transition">
                    Kembali ke Beranda
                </a>
            </div>
        <?php endif; ?>
...
<?php /**PATH E:\Kerja\Web-BPS\web-BPS\resources\views/publications/show.blade.php ENDPATH**/ ?>