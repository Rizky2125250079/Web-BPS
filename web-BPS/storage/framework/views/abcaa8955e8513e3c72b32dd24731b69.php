...
<head>
    ...
    <title><?php echo e($detail['title'] ?? 'Detail Press Release'); ?> - Portal BPS</title>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden p-6 md:p-10">
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-2 mt-4 text-xs text-gray-500 border-b border-gray-100 pb-6">
                    <span class="flex items-center gap-1.5">
                        ...
                        Rilis: <?php echo e(!empty($detail['rl_date']) ? \Carbon\Carbon::parse($detail['rl_date'])->locale('id')->translatedFormat('d F Y') : '-'); ?>

                    </span>
                    <?php if(!empty($detail['updt_date'])): ?>
                        <span class="flex items-center gap-1.5">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>
                            </svg>
                            Diperbarui: <?php echo e(\Carbon\Carbon::parse($detail['updt_date'])->locale('id')->translatedFormat('d F Y')); ?>
...
<?php /**PATH E:\Kerja\Web-BPS\web-BPS\resources\views/pressreleases/show.blade.php ENDPATH**/ ?>